...
const HomeScreen = () => {
  ...
  return (
    ...
    <View style={{ flex: 1, marginTop: 0  }}>
      ...
      <Text style={{ fontSize: 23, marginTop: 10 ,marginLeft:93,color:'#ffffff' }}>อาคารกีฬาแบดมินตัน</Text>
      <Text style={{ fontSize: 23, marginTop: 5,marginLeft:82,color:'#ffffff'  }}>มหาวิทยาลัยวลัยลักษณ์</Text>
      <Text style={{ fontSize: 20, marginTop: 15 ,marginLeft:15,color: '#7d539d' }}>ระเบียบข้อปฏิบัติ</Text>
...
หากผู้เข้าใช้บริการไม่ปฏิบัติตามกฎเกณฑ์ที่กำหนด</Text>
      ...
      <Text style={{ fontSize: 20, marginTop: 15 ,marginLeft:15,color: '#7d539d' }}>อัตราค่าเข้าใช้บริการ</Text>
      ...
      <Text style={{ fontSize: 20, marginTop: 15 ,marginLeft:15,color: '#7d539d' }}>เวลาเปิดทำการ</Text>
